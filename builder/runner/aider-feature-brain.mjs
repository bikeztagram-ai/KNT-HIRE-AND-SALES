...
const objectives=loadObjectives(),loaded=loadAiderState(statePath,{protocol,completed:[],failed:[],runs:0,inProgress:null}),state=loaded.state;
...
const o=objective();if(!o){console.log(JSON.stringify({ok:true,protocol,status:'no-eligible-objective',product:productMarker}));process.exit(0)}
